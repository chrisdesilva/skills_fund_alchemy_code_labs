...
export const leadContent = {
	...
	paragraph: `${schoolName} designs its programs to help students launch a career in software development. ${schoolName} partners with Skills Fund to offer tuition${faq.costOfLiving
		? ' and cost of living'
...
export const threeStepCardText = {
	...
	step2: {
		...
		text: 'Alchemy Code Lab focuses exclusively on its Program in Professional Software Development.'
	},
