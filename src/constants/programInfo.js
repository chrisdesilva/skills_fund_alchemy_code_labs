...
export const schoolInfo = { // term details section
    ...
    APRRange36: '11.01 - 11.34%',
    APRRange60: '12.44 - 12.58%',
    interestOnly: [
        { // for multiple examples of interest only, add items to interestOnly array
            programName: 'the Bootcamp Part One course or Bootcamp Part Two course',
            APR36: '11.34%',
        ...
        { // for multiple examples of interest only, add items to interestOnly array
            programName: 'the Bootcamp Part One & Two bundle',
            APR36: '11.25%',
        ...
        { // for multiple examples of interest only, add items to interestOnly array
            programName: 'the Career Track course',
            APR36: '11.16%',
        ...
        { // for multiple examples of interest only, add items to interestOnly array
            programName: 'the Bootcamp Part Two + Career Track bundle',
            APR36: '11.08%',
        ...
        { // for multiple examples of interest only, add items to interestOnly array
            programName: 'the Bootcamp Part One & Two + Career Track bundle',
            APR36: '11.01%',
...
export const faq = { // faq section
    ...
    loanRange: [
        {
            programName: "Bootcamp Part One",
            maxAmount: "$3,500",
            col: true,
            colAmount: "$2,250"
        },
        {
            programName: "Bootcamp Part Two",
            maxAmount: "$4,500",
            col: true,
            colAmount: "$2,250"
        },
        {
            programName: "Career Track",
            maxAmount: "$12,000",
            col: true,
            colAmount: "$6,000"
        },
        {
            programName: "Bootcamp Part One & Two Bundle",
            maxAmount: "$8,000",
            col: true,
            colAmount: "$4,500"
        },
        {
            programName: "Bootcamp Part Two + Career Track Bundle",
            maxAmount: "$16,500",
            col: true,
            colAmount: "$8,250"
        },
        {
            programName: "Bootcamp Part One & Two + Career Track Bundle",
            maxAmount: "$20,000",
            col: true,
            colAmount: "$10,500"
        },
...
export const leadContent = {
    ...
    paragraph: `${schoolName} designs its programs to help students launch a career in software development. ${schoolName} partners with Skills Fund to offer tuition${faq.costOfLiving ? ' and cost of living' : ''} financing so more students like you can access their program.`
}
...
export const threeStepCardText = {
    ...
    step2: {
        ...
        text: "Choose between Bootcamp Part One, Bootcamp Part Two, Bootcamp Part One & Two Bundle, Career Track, Bootcamp Part Two + Career Track, or Bootcamp Part One & Two + Career Track."
    },
...
export const hubspotFormId = "b2935f17-0f48-4323-b341-651b1d288103" // create Hubspot form, get form id after publishing

export const selectAProgram = "select_a_alchemy_program" // update school name to match form field on Hubspot, *** change to "program_name" if only one program ***"
...
export const programMaxText = "Choose the loan amount that works best for you. Borrow up to your program's max according to the table below."
