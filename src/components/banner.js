...
const Banner = props => {
    ...
    <div className='flex flex-col justify-center items-center relative z-0' id='banner'>
        ...
        <h1 className='text-3xl lg:text-4xl font-normal text-center mt-8 text-black px-4'>{applicationsLive ? headline : `Applications for ${schoolName} financing will be available soon`}</h1>
        <h2 className='text-base lg:text-xl font-light text-center text-black'>{applicationsLive ? `Know exactly what you'll pay with Skills Fund` : `Click to be notified when the application is live`}</h2>
